...
const Footer = () => {
  return (
    <footer className="footer items-center p-4 bg-neutral-900 text-base-content">
  <div className="items-center grid-flow-col">
    ...
    <p>KYN-ProjectAssignment © 2023 - All right reserved</p>
  </div> 
  <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
  <button className="link-icon" type="button">
